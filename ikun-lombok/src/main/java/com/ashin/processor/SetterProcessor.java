...
@SupportedAnnotationTypes("com.ashin.annotation.Setter")
        ...
        set.forEach(element -> {
            ...
            jcTree.accept(new TreeTranslator() {
                ...
                public void visitClassDef(JCTree.JCClassDecl jcClassDecl) {
                    ...
                    jcVariableDeclList.forEach(jcVariableDecl -> jcClassDecl.defs = jcClassDecl.defs.prepend(makeSetterMethodDecl(jcVariableDecl)));
